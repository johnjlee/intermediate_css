...
function triggerEnterEvent(no) {
  ...
  // Added hack: when we enter the page, re-render whatever's in the
  // frame.  Not sure why leaving the slide clears the frame.. but
  // whatever.
  var article = document.getElementsByTagName('article')[no];
  var editors = article.getElementsByClassName('editor');
...
function handleBodyKeyDown(event) {
  // A hack to ignore key events on textareas.
